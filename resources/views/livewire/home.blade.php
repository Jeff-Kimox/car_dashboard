    ...
    <div class="bg-gray-700 p-4 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
          <div class="md:w-2/3 lg:w-1/2 mt-12 text-gray-100">
            ...
            <h2 class="my-8 text-2xl font-bold text-white md:text-4xl">Home page</h2>
            <p class="text-gray-300">This page will show driver stats or we can show the steps to use the platform</p>
          </div>
          <div
            ...
            <div class="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl  hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  <h5 class="text-xl font-semibold text-white transition group-hover:text-secondary">4</h5>
                  <p class="text-gray-300">How many trips the driver has made</p>
                </div>
              </div>
            </div>
            <div class="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  <h5 class="text-xl font-semibold text-white transition group-hover:text-secondary">Company name</h5>
                  <p class="text-gray-300">The company the driver belongs to</p>
                </div>
              </div>
            </div>
            <div class="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  <h5 class="text-xl font-semibold text-white transition group-hover:text-secondary">rating</h5>
                  <p class="text-gray-300">Other diver stats like rating</p>
                </div>
              </div>
            </div>
            <div class="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  <h5 class="text-xl font-semibold text-white transition group-hover:text-secondary">Cars</h5>
                  <p class="text-gray-300">The cars the driver has been using</p>
                </div>
              </div>
            </div>
          </div>
...
<section id="explore" class="mt-16 px-8 pb-8">
